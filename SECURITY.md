...
- **Preferred**: Use [GitHub Security Advisories](https://docs.github.com/en/code-security/security-advisories/working-with-repository-security-advisories/creating-a-repository-security-advisory) to report. When using this template, use your repository’s security advisories page instead. This allows confidential collaboration and coordinated disclosure.
