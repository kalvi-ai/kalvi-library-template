...
- **Preferred**: Use [GitHub Security Advisories](https://github.com/kalvi-library-template/kalvi-library-template/security/advisories/new) (replace with your repo path) to report the issue. This allows confidential collaboration and coordinated disclosure.
