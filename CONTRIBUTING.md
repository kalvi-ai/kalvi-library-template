...
- **Markdown / docs**: Lint with [.markdownlint.yaml](.markdownlint.yaml). Use real headings (`##`, `###`) for section titles, not standalone bold. Pre-commit runs markdownlint on commit.
